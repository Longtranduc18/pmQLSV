...
@Entity
@Table(name = "LichSuChamSocEN")
public class LichSuChamSocEN implements Serializable {
	@Id
	...
	public LichSuChamSocEN() {

	}

	public LichSuChamSocEN(ChienDichCD chienDichCD, HocKi hocKi, ChienDich chienDich, NhanSu nhanSu, String mssv,
    ...
    public LichSuChamSocEN(ChienDich chienDich, NhanSu nhanSu, java.util.Date thoiGianCS, String lyDoGhiNhan, String phanLoaiNguyCo, String DienGiaiCT) {
        this.chienDich = chienDich;
        this.nhanSu = nhanSu;

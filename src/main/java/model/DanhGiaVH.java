...
@Entity
@Table(name = "DanhGiaVH")
public class DanhGiaVH implements Serializable {
    ...
    public DanhGiaVH(ChienDichCD chienDichCD, SinhVien sinhVien, NhanSu nhanSu, HocKi hocKi, ChienDich chienDich,
            String maMon) {
